 ...
 */
#ifndef RTW_HEADER_helicopter_statefeedback_h_
#define RTW_HEADER_helicopter_statefeedback_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_statefeedback_COMMON_INCLUDES_
# define helicopter_statefeedback_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter_statefeedback_COMMON_INCLUDES_ */

#include "helicopter_statefeedback_types.h"
...
#define helicopter_statefeedback_rtModel RT_MODEL_helicopter_statefeed_T
...
} XDis_helicopter_statefeedback_T;
...
#define rtB                            helicopter_statefeedback_B
#define BlockIO                        B_helicopter_statefeedback_T
#define rtX                            helicopter_statefeedback_X
#define ContinuousStates               X_helicopter_statefeedback_T
#define rtXdot                         helicopter_statefeedback_XDot
#define StateDerivatives               XDot_helicopter_statefeedback_T
#define tXdis                          helicopter_statefeedback_XDis
#define StateDisabled                  XDis_helicopter_statefeedback_T
#define rtP                            helicopter_statefeedback_P
#define Parameters                     P_helicopter_statefeedback_T
#define rtDWork                        helicopter_statefeedback_DW
#define D_Work                         DW_helicopter_statefeedback_T

/* Parameters (auto storage) */
struct P_helicopter_statefeedback_T_ {
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S3>/Integrator'
                                        */
  real_T elevation_ref_Value;          /* Expression: 0.1
...
struct tag_RTM_helicopter_statefeedb_T {
  const char_T *path;
...
extern P_helicopter_statefeedback_T helicopter_statefeedback_P;

/* Block signals (auto storage) */
extern B_helicopter_statefeedback_T helicopter_statefeedback_B;

/* Continuous states (auto storage) */
extern X_helicopter_statefeedback_T helicopter_statefeedback_X;

/* Block states (auto storage) */
extern DW_helicopter_statefeedback_T helicopter_statefeedback_DW;

/* Model entry point functions */
extern void helicopter_statefeedback_initialize(void);
extern void helicopter_statefeedback_output(void);
extern void helicopter_statefeedback_update(void);
extern void helicopter_statefeedback_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter_statefeed_T *const helicopter_statefeedback_M;
 ...
 *
 * '<Root>' : 'helicopter_statefeedback'
 * '<S1>'   : 'helicopter_statefeedback/Conversion'
 * '<S2>'   : 'helicopter_statefeedback/Degrees to Radians'
 * '<S3>'   : 'helicopter_statefeedback/Elevation controller'
 * '<S4>'   : 'helicopter_statefeedback/Helicopter_interface'
 * '<S5>'   : 'helicopter_statefeedback/Pitch controller'
 * '<S6>'   : 'helicopter_statefeedback/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter_statefeedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter_statefeedback/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter_statefeedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter_statefeedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter_statefeedback/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter_statefeedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_statefeedback_h_ */
