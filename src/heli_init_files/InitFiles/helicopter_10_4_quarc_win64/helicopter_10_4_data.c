...
P_helicopter_10_4_T helicopter_10_4_P = {
  10.424736663268774,                  /* Variable: K_ed
                                        * Referenced by: '<S3>/K_ed'
                                        */
  0.26061841658171936,                 /* Variable: K_ei
                                        * Referenced by: '<S3>/K_ei'
                                        */
  2.6061841658171936,                  /* Variable: K_ep
                                        * Referenced by: '<S3>/K_ep'
                                        */
  4.9076452599388389,                  /* Variable: K_pd
                                        * Referenced by: '<S5>/K_pd'
                                        */
  4.4168807339449554,                  /* Variable: K_pp
