 ...
 */
#ifndef RTW_HEADER_helicopter_follow_h_
#define RTW_HEADER_helicopter_follow_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_follow_COMMON_INCLUDES_
# define helicopter_follow_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter_follow_COMMON_INCLUDES_ */

#include "helicopter_follow_types.h"
...
#define helicopter_follow_rtModel      RT_MODEL_helicopter_follow_T
...
#define rtB                            helicopter_follow_B
#define BlockIO                        B_helicopter_follow_T
#define rtX                            helicopter_follow_X
#define ContinuousStates               X_helicopter_follow_T
#define rtXdot                         helicopter_follow_XDot
#define StateDerivatives               XDot_helicopter_follow_T
#define tXdis                          helicopter_follow_XDis
#define StateDisabled                  XDis_helicopter_follow_T
#define rtP                            helicopter_follow_P
#define Parameters                     P_helicopter_follow_T
#define rtDWork                        helicopter_follow_DW
#define D_Work                         DW_helicopter_follow_T

/* Parameters (auto storage) */
struct P_helicopter_follow_T_ {
...
struct tag_RTM_helicopter_follow_T {
  const char_T *path;
...
extern P_helicopter_follow_T helicopter_follow_P;

/* Block signals (auto storage) */
extern B_helicopter_follow_T helicopter_follow_B;

/* Continuous states (auto storage) */
extern X_helicopter_follow_T helicopter_follow_X;

/* Block states (auto storage) */
extern DW_helicopter_follow_T helicopter_follow_DW;

/* Model entry point functions */
extern void helicopter_follow_initialize(void);
extern void helicopter_follow_output(void);
extern void helicopter_follow_update(void);
extern void helicopter_follow_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter_follow_T *const helicopter_follow_M;
 ...
 *
 * '<Root>' : 'helicopter_follow'
 * '<S1>'   : 'helicopter_follow/Conversion'
 * '<S2>'   : 'helicopter_follow/Degrees to Radians'
 * '<S3>'   : 'helicopter_follow/Elevation controller'
 * '<S4>'   : 'helicopter_follow/Helicopter_interface'
 * '<S5>'   : 'helicopter_follow/Pitch controller'
 * '<S6>'   : 'helicopter_follow/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter_follow/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter_follow/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter_follow/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter_follow/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter_follow/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter_follow/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_follow_h_ */
