...
ylabel('u')
title(['\fontsize{20} {\color{magenta} q = 0.1 '...
'\color{blue} q = 1 \color{green} q = 10 }'])
...
plot(states2(1:81,1),states2(1:81,4),'b')
plot(states3(1:81,1),states3(1:81,4),'g')
ylabel('r')
axis([0 20 -inf inf])
...
plot(states2(1:81,1),states2(1:81,5),'b')
plot(states3(1:81,1),states3(1:81,5),'g')
ylabel('p'),xlabel('t')

subplot(3,2,6)
hold on;
plot(states1(1:81,1),states1(1:81,6),'m'),grid
plot(states2(1:81,1),states2(1:81,6),'b')
plot(states3(1:81,1),states3(1:81,6),'g')
